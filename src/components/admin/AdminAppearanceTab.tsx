        ...
        <CardHeader>
          ...
          <CardDescription className="space-y-1">
            ...
            <span className="block text-xs">
              <span className="font-medium text-foreground">@{import.meta.env.VITE_CLIENT_BOT || 'ezzeprogo_bot'}</span> — для клиентов &nbsp;·&nbsp;
              <span className="font-medium text-foreground">@{import.meta.env.VITE_MASTER_BOT || 'ezzepro_bot'}</span> — для мастеров
            </span>
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              <Label className="text-xs">
                Кнопка для клиентов
                <span className="ml-1.5 text-muted-foreground font-normal">(@{import.meta.env.VITE_CLIENT_BOT || 'ezzeprogo_bot'})</span>
              </Label>
              <Input
                value={tgClientLabel}
            ...
            <div className="space-y-1.5">
              <Label className="text-xs">
                Кнопка для мастеров
                <span className="ml-1.5 text-muted-foreground font-normal">(@{import.meta.env.VITE_MASTER_BOT || 'ezzepro_bot'})</span>
              </Label>
              <Input
                value={tgMasterLabel}
