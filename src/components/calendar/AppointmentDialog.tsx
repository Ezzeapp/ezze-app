...
export function AppointmentDialog({
  ...
  // Список клиентов (левая колонка на десктопе) — поиск или топ-20 по визитам
  const clientsForList = useMemo(() => {
    ...
    const arr = q
      ...
      : [...clients].sort((a, b) => (b.total_visits ?? 0) - (a.total_visits ?? 0))
                ...
                <div className="hidden lg:flex flex-col w-[40%] overflow-y-auto bg-muted/20">
                  ...
                  <div className="flex-1 overflow-y-auto px-5 py-4 space-y-5">
                    ...
                    {PRODUCT === 'clinic' && editAppt && (editAppt.status === 'done' || status === 'done') && (
                      <ClinicVisitPanel appointmentId={editAppt.id} clientId={selectedClient?.id} clientName={clientFullName} />
                    )}
                ...
                <div className="shrink-0 border-t px-4 py-3 flex items-center justify-between bg-background">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button type="button" loading={isLoading} disabled={!canSave} onClick={handleSubmit} className="gap-2">
                      ...
                      {!editAppt && canSave && (basePrice > 0 ? finalPrice : totalBasePrice) > 0 && (
