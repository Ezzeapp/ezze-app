...
>(({ className, variant = 'default', ...props }, ref) => {
  const variants = {
    ...
    success: 'border-emerald-200 bg-emerald-50 text-emerald-900 dark:bg-emerald-900 dark:text-emerald-100 dark:border-emerald-800',
  }
  return (
    <ToastPrimitive.Root
      ref={ref}
      className={cn(
        'group pointer-events-auto relative flex w-full items-center justify-between space-x-2 overflow-hidden rounded-lg border p-4 pr-6 shadow-lg',
