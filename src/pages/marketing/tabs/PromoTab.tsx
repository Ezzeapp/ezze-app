// PromoTab — промокоды (контент из PromoCodesPage без PageHeader)
...
export function PromoTab() {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      toast.error(err?.message || t('promo.createError'))
    }
  }
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-3 items-end flex-wrap">
              <div className="space-y-1">
                ...
                <Input
                  type="text" placeholder="01.01.2000" maxLength={10}
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <Badge variant={promo.is_active && !isExpired && !isExhausted ? 'default' : 'outline'}>
                        {isExpired
                          ...
                          : isExhausted
                            ? t('promo.statusExhausted')
                            : promo.is_active
                              ? t('promo.statusActive')
                              : t('promo.statusInactive')}
                      </Badge>
                    </div>
